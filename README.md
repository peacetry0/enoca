...
| GET         | `/api/v1.0/products/check-stock/{id}/{quantity}` | Ürün stok durumunu kontrol eder.    |
| POST        | `/api/v1.0/products/reduce-stock/{id}/{quantity}` | Belirtilen miktarda stok düşer.    |
